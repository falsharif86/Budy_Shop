...
<svg class={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width={strokeWidth}>
	...
	<path d="M6.75 6.75h.75v.75h-.75V6.75zM6.75 16.5h.75v.75h-.75V16.5zM16.5 6.75h.75v.75h-.75V6.75zM13.5 13.5h.75v.75h-.75v-.75zM13.5 19.5h.75v.75h-.75v-.75zM19.5 13.5h.75v.75h-.75v-.75zM19.5 19.5h.75v.75h-.75v-.75zM16.5 16.5h.75v.75h-.75v-.75z" />
</svg>
